...
<p>
    ...
    There are 3 kinds of additional chain context(<span class="code">&</span>, <span class="code">~</span>, <span class="code">=</span>).
</p>
<h2>Lonely Chain <span class="code">&</span></h2>
<p>
    If lonely chain's receiver is <span class="code">nil</span>,
    it ignores call and return <span class="code">nil</span>.
</p>
...
<h2>Practice</h2>
<p>
    (1) What happens if you remove the lonely chain in the source code?
</p>
<p>
    (1) What happens if you remove the thoughtful chain in the source code?
</p>