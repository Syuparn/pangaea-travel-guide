...
<h1>Object System</h1>
<p>
  Pangaea has prototype-based object system. Int literals inherits <span
    class="code">Int</span
  >
  object, which inherits <span class="code">Obj</span> object, and all objects
  inherits <span class="code">BaseObj</span> object.
</p>
<p>
...
<p>
  Property call uses prototype chain. Even if the object does not have the
  specified property, it can also use its prototype's properties. With method <span
    class="code">which</span
  >, you can check whose property is called.
</p>
<h2>Practice</h2>
<p>
...
<p>
  (3) List up properties of <span class="code">Int</span>. Property names can be
  obtained by method <span class="code">keys</span>.
</p>
