...
<h1>List Chain</h1>
<p>
    In dot chain, the receiver is its left-side value.
    On the other hand, in list chain, the receiver is <strong>each element of</strong> its right-side value iterator.
    Once the all elements are evaluated, list chain packs them into an array.
</p>
<p>
    If you want to make objects other than an array,
    you can use <i>chain arg</i> to specify the object type.
</p>
<h2>Practice</h2>
<p>
...
<p>
    (2) Almost all built-in objects have their iterators.
    Check What is printed when you use <span class="code">@p</span> for some objects
    (ex:
