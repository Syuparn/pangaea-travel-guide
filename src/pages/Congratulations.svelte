...
<p>
    You finished all sections🎉
</p>
<p>
    You are ready to start Pangaea language.
    Let's check the <a href="https://github.com/Syuparn/Pangaea/releases">binary release page</a>.
    For further language specifications,
